                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="reply-staff.php?tid=<?php echo htmlentities($row['teacboo']); ?>&&action=rep" onclick="return confirm('Do you realy want to Approve this request ?')" class=" btn btn-success">YES</a>
                                                            <a href="reply-staff.php?tid1=<?php echo htmlentities($row['teacboo']); ?>&&action1=rep" onclick="return confirm('Do you realy want to say NO ?')" class="btn btn-danger">NO</a>
                                                            <form method="POST">
