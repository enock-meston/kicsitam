...
$query=mysqli_query($con,"update tbltools set ActiveStatus=1 where id='$postid'");
if($query)
{
...
if($_GET['presid'])
{
    ...
    $query=mysqli_query($con,"delete from  tbltools  where id='$id'");
...
<td>
<a href="trash-tools.php?pid=<?php echo htmlentities($row['toolid']);?>&&action=restore" onclick="return confirm('Do you really want to restore ?')"> <i class="ion-arrow-return-right" title="Restore this Post"></i></a>
    &nbsp;
    <a href="trash-tools.php?presid=<?php echo htmlentities($row['toolid']);?>&&action=perdel" onclick="return confirm('Do you really want to delete ?')"><i class="fa fa-trash-o" style="color: #f05050" title="Permanently delete this post"></i></a> 
 </td>
 </tr>
<?php } }?>
