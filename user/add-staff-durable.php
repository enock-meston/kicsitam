                                        ...
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group m-b-20">
                                             ...
                                             <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="posttitle" name="hotsport" placeholder="Enter HotSport" required>
                                            </div>

                                             <div class="form-group m-b-20">
                                                <label for="exampleInputEmail1">Room </label>
                                                <input type="text" class="form-control" id="posttitle" name="room" placeholder="Enter Room" required>
                                            </div>
                                            ...
                                            <div class="form-group m-b-20">
                                                ...
                                                <select class="form-control" name="staffID" id="category" onChange="getSubCat(this.value);" required>
