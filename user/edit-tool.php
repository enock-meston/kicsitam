...
$query=mysqli_query($con,"update tbltools set Toolname='$posttitle',ToolCategory='$catid',ToolDescription='$postdetails',ActiveStatus='$status' where id='$postid'");
if($query)
{
$msg="Tool updated ";
}
...
from tbltools left join tblcategory on tblcategory.c_id=tbltools.ToolCategory where tbltools.ActiveStatus=1 and tbltools.id='$postid'");
