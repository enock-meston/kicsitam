...
<html lang="en">
    <head>
        ...
        <title><?php echo $_SESSION['fn']." ".$_SESSION['ln'];?> | Edit Category</title>
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($con,"Select c_id,CategoryName,Description,PostDate from tblcategory where Is_Active=1 and c_id='$catid'");
$cnt=1;
