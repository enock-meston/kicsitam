...
if (strlen($_SESSION['id']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "SELECT * FROM tblstudent WHERE id='".$_SESSION['id']."'");
        if ($row = mysqli_fetch_array($sql)) {
            ...
            if (strpos($newpassword,'@')==false && strpos($newpassword,'%')== false) {
                ...
                $updatePass = mysqli_query($con, "UPDATE tblstudent SET password='$newpassword' WHERE id='$staffid'");
