                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        ...
                                        <div class="wigdet-one-content">
                                            ...
                                            <?php 
                                            $stuID=$_SESSION['id'];
                                            $query = mysqli_query($con, "SELECT * from studentbookingtbl where studentID ='$stuID'");
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        ...
                                        <div class="wigdet-one-content">
                                            ...
                                            <?php 
                                            $stuID=$_SESSION['id'];
                                            $query = mysqli_query($con, "SELECT * from studentbookingtbl where studentID ='$stuID' AND ActiveStatus=1 AND BookStatus=1");
                                            $countcat = mysqli_num_rows($query);
                                            ?>
                                            <h2><?php echo htmlentities($countcat); ?> <small></small></h2>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        ...
                                        <div class="wigdet-one-content">
                                            ...
                                            <?php 
                                            $stuID=$_SESSION['id'];
                                            $query = mysqli_query($con, "SELECT * from studentbookingtbl where studentID ='$stuID' AND ActiveStatus=1 AND BookStatus=0");
                                            $countcat = mysqli_num_rows($query);
                                            ?>
                                            <h2><?php echo htmlentities($countcat); ?> <small></small></h2>
